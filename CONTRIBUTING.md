...
Version-controllable contributions toward improving [.make](README.md) (its source code, documentation, etc.) are welcome via GitHub's [pull request](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-requests) process.  By submitting a pull request, you acknowledge and agree to the following:

1. You have the right to license your contribution to [djrlj694.dev](support@djrlj694.dev) and the .make project community;
